...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__ubermanu_sveltekit_websocket: string;
	export const __CFBundleIdentifier: string;
	export const PWD: string;
	export const npm_command: string;
	export const npm_package_dependencies_y_indexeddb: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__ubermanu_sveltekit_websocket: string;
		__CFBundleIdentifier: string;
		PWD: string;
		npm_command: string;
		npm_package_dependencies_y_indexeddb: string;
